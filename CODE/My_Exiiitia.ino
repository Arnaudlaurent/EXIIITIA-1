...
//const settings
const int   outThumbMax   =   110;     //right:open | left:close
const int   outThumbMin   =   30;    //right:close | left:open
const int   outIndexMax   =   180;    //right:open | left:close
const int   outIndexMin   =   30;     //right:close | left:open
const int   outOtherMax   =   150;    //right:open | left:close
const int   outOtherMin   =   50;    //right:close | left:open
//variables
 ...
 *               - "BLOQUE FERMÃ‰"  : blocks the hand in CLOSED position
    ...
    if(com == 0x11){    
      ...
      while((currentBlock - previousBlock < intBlock) && (com != 0x15)){
        ...
        switch(com){
          ...
          //Checking for "BLOQUE FERME" command
          case 0x13:
            colorLED('N');                    //Switching the RGB LED OFF          
